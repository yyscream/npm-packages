...
assert.match(css, /@media \(max-width: 1050px\)[\s\S]*?\.side-panel-expand-button \{[\s\S]*?z-index:\s*22/, "narrow side-panel expand button should stay above the terminal header while collapsed");
